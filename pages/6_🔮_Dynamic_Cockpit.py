...
# ==========================================
# [新增] 本地 HS Code 定义 (参考 MarketIntel 逻辑)
# ==========================================
# 明确区分 Logs (原木) 和 Lumber (板材)
LOCAL_HS_CODES_MAP = {
    "Softwood Logs (针叶原木)": [
        "440320", "440321", "440322", "440323", "440324", "440325", "440326"
    ],
    "Softwood Lumber (针叶板材)": [
        "440710", "440711", "440712", "440713", "440714", "440719"
    ],
    "Hardwood Logs (阔叶原木)": [
        "440390", "440341", "440349", "440391", "440393", "440394", 
        "440395", "440396", "440397", "440398", "440399"
    ],
    "Hardwood Lumber (阔叶板材)": [
        "440721", "440722", "440723", "440725", "440726", "440727", 
        "440728", "440729", "440791", "440792", "440793", "440794", 
        "440795", "440796", "440797", "440799"
    ],
    "All Softwood (所有针叶)": [
        # Logs
        "440320", "440321", "440322", "440323", "440324", "440325", "440326",
    ...
    "All Hardwood (所有阔叶)": [
        # Logs
        "440390", "440341", "440349", "440391", "440393", "440394", "440395", 
        "440396", "440397", "440398", "440399",
        # Lumber
        "440721", "440722", "440723", "440725", "440726", "440727", "440728", 
        "440729", "440791", "440792", "440793", "440794", "440795", "440796", 
        "440797", "440799"
    ]
}
...
with st.sidebar:
    ...
    # 1. 产品分类 (使用新的 LOCAL_HS_CODES_MAP)
    # 优先使用本地定义，如果 config 中有其他键值也可以保留，这里主要覆盖核心逻辑
    category_options = list(LOCAL_HS_CODES_MAP.keys())
    ...
    target_hs_codes = LOCAL_HS_CODES_MAP.get(selected_category, [])
...
if st.session_state.get('report_active', False) and not st.session_state['analysis_df'].empty:
    ...
    # --- [修改] 根据新分类做逻辑保护 ---
    # 如果选了 Softwood，就自动过滤掉 Hardwood 树种，反之亦然
    ...
    if df.empty:
        ...
        with st.expander("🧹 Smart Outlier Filter (异常值智能清洗)", expanded=True):
            ...
            with c_cl1: st.info("💡 Enable this to auto-remove records with extremely low unit price (e.g. KG mislabeled as M3).")
